    ...
    return (
        <PageContainer title={"Inicio"}>
            <HomeSection1Container>
                <PageSection>
                    <Typography variant="h4" sx={{color: "#fff", wordBreak: "break-word", pt: 10, ml: {xs:0, md:2},width: {xs: "100%", md: "60%", lg: "40%"}} }>Somos especialistas en atención al cliente</Typography>
                </PageSection>
            </HomeSection1Container>
            ...
            <PageSection>
                <Grid container sx={{py:8}}>
                    <Grid item xs={12} md={6}>
                        <Box sx={{width: {xs: "100%", md: "80%"}, mt:{xs: 0, md: 8}, textAlign: {xs: "center", md: "left"}}}>
                    ...
                    <Grid item xs={12} md={6} >
                        ...
                        <Image src={"https://statics.helpia.com/landing/Lateral.gif"} alt={"Lateral.gif"} width={364} height={422} />
                        </Box>
                    </Grid>
                </Grid>
            </PageSection>
            ...
            <HomeSection2Container>
                <PageSection>
                    <Grid container sx={{py:8}}>
                        <Grid item xs={12} md={6}>
                            <Box sx={{width: {xs: "100%", md: "80%"}, mt:{xs: 0, md: 8}, textAlign: {xs: "center", md: "left"}}}>
                                <Typography variant="h4" sx={{color: "primary.light",fontWeight: "bold", mb:2}}>¿Cómo lo hacemos?</Typography>
                        ...
                        <Grid item xs={12} md={6} >
                            <Box sx={{display: "flex", justifyContent: "center"}}>
                                <Image src={"https://statics.helpia.com/landing/Frente_1-1-422x600.png"} alt={"Frente_1-1-422x600.png"} width={360} height={511} />
                            </Box>
                        </Grid>
                    </Grid>
                </PageSection>
            ...
            <HomeSection3Container>
                <PageSection>
                    <Grid container sx={{py:8}}>
                        ...
                        <Grid item xs={12} md={6} >
                            <Box>
                                <Image src={"https://statics.helpia.com/landing/Frente_3-1-1.png"} alt={"Frente_3-1-1.png"} width={350} height={522} />
                            </Box>
                        </Grid>
                        <Grid item xs={12} md={6}>
                            <Box sx={{width: {xs: "100%", md: "80%"}, mt:{xs: 0, md: 8}, textAlign: {xs: "center", md: "left"}}}>
                                <Typography variant="h4" sx={{fontWeight: "bold", mb:2}}>Disponibilidad 24/7</Typography>
